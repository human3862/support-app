...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_media_and_text_layout" AS ENUM('imageRight', 'imageLeft');
  ...
  CREATE TABLE "pages_blocks_media_and_text" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"layout" "enum_pages_blocks_media_and_text_layout" DEFAULT 'imageRight',
  	"title" varchar NOT NULL,
  	"description" varchar,
  	"image_id" integer NOT NULL,
  	"button_label" varchar,
  	"button_link" varchar,
  	"button_variant" "enum_pages_blocks_media_and_text_button_variant" DEFAULT 'primary',
  	"block_name" varchar
  );
  ...
  ALTER TABLE "pages_blocks_media_and_text" ADD CONSTRAINT "pages_blocks_media_and_text_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_media_and_text_image_idx" ON "pages_blocks_media_and_text" USING btree ("image_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_pages_blocks_media_and_text_layout";
